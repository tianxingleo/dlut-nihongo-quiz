...
export const CATEGORIES: CategoryMeta[] = [
  ...
  },
  {
    ...
    groupOrder: ['t0', 't1', 't2', 't3', 't5-1', 't5-2', 't5-3', 't5-4', 'hist-a', 'hist-b', 'hist-c'],
    groupViewTitle: '刷题单',
  ...
  },
  {
    ...
    groupOrder: ['party-single', 'party-multi', 'party-judge', 'party-p1', 'party-p2', 'party-p3', 'party-p4'],
  ...
  },
  {
    ...
    groupViewHint: '每单独立计分。「按章节」组与「按优先级」组共享同一批题目；P1 必考核心建议先刷。',
  },
]
...
export const NO_SHUFFLE_CATEGORIES: ReadonlySet<Category> = new Set(['history', 'party', 'military'])
